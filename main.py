...
from Car_Price_Prediction_System.pipelines.stage_04_model_trainer import ModelTrainerPipeline
from Car_Price_Prediction_System.pipelines.stage_05_model_evaluation import ModelEvaluationPipeline
